{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 2.0, 44.0, 712.0, 579.0 ],
		"bglocked" : 0,
		"defrect" : [ 2.0, 44.0, 712.0, 579.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 427.0, 294.0, 99.0, 31.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 303.0, 294.0, 99.0, 31.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.0, 336.0, 127.0, 29.0 ],
					"text" : "saturation $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 336.0, 129.0, 29.0 ],
					"text" : "brightness $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.0, 336.0, 112.0, 29.0 ],
					"text" : "contrast $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 134.0, 521.0, 384.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 394.0, 91.0, 31.0 ],
					"text" : "jit.brcosa"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 136.0, 222.0, 193.0, 31.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 466.5, 284.0, 436.5, 284.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 466.5, 284.0, 312.5, 284.0 ],
					"source" : [ "obj-8", 0 ]
				}
