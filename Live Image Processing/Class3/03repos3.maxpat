{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 25.0, 69.0, 1216.0, 571.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 69.0, 1216.0, 571.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "loadbang",
					"numinlets" : 1,
					"patching_rect" : [ 23.0, 128.0, 85.0, 27.0 ],
					"numoutlets" : 1,
					"id" : "obj-5",
					"fontsize" : 18.0,
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					...
					"text" : "delay 2000",
					"numinlets" : 2,
					"patching_rect" : [ 11.0, 167.0, 99.0, 27.0 ],
					"numoutlets" : 1,
					"id" : "obj-2",
					"fontsize" : 18.0,
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					...
					"text" : "loadbang",
					"numinlets" : 1,
					"patching_rect" : [ 245.0, 15.0, 85.0, 27.0 ],
					"numoutlets" : 1,
					"id" : "obj-52",
					"fontsize" : 18.0,
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numinlets" : 1,
					"patching_rect" : [ 9.0, 372.0, 20.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-51",
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "sel 27",
					"numinlets" : 2,
					"patching_rect" : [ 21.0, 296.0, 59.0, 27.0 ],
					"numoutlets" : 2,
					"id" : "obj-23",
					"fontsize" : 18.0,
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "key",
					"numinlets" : 0,
					"patching_rect" : [ 25.0, 249.0, 59.5, 27.0 ],
					"numoutlets" : 4,
					"id" : "obj-22",
					"fontsize" : 18.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 21.0, 526.0, 213.0, 27.0 ],
					"numoutlets" : 2,
					"id" : "obj-21",
					"fontsize" : 18.0,
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numinlets" : 2,
					"patching_rect" : [ 1083.0, 64.0, 114.0, 46.0 ],
					"numoutlets" : 1,
					"id" : "obj-40",
					"fontsize" : 18.0,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "importmovie liquid.tif",
					"numinlets" : 2,
					"patching_rect" : [ 887.0, 76.0, 175.0, 25.0 ],
					"numoutlets" : 1,
					"id" : "obj-43",
					"fontsize" : 18.0,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"patching_rect" : [ 771.0, 33.0, 184.0, 25.0 ],
					"numoutlets" : 1,
					"id" : "obj-31",
					"fontsize" : 18.0,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "importmovie repos.tif",
					"numinlets" : 2,
					"patching_rect" : [ 623.0, -1.0, 178.0, 25.0 ],
					"numoutlets" : 1,
					"id" : "obj-10",
					"fontsize" : 18.0,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numinlets" : 1,
					"patching_rect" : [ 52.0, 13.0, 20.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-6",
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "metro 2",
					"numinlets" : 2,
					"patching_rect" : [ 48.0, 54.0, 72.0, 27.0 ],
					"numoutlets" : 1,
					"id" : "obj-4",
					"fontsize" : 18.0,
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					...
					"text" : "read feet2.mov",
					"numinlets" : 2,
					"patching_rect" : [ 237.0, 57.0, 132.0, 25.0 ],
					"numoutlets" : 1,
					"id" : "obj-3",
					"fontsize" : 18.0,
					"outlettype" : [ "" ],
