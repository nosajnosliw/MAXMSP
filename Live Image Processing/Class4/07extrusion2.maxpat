{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 122.0, 50.0, 1218.0, 602.0 ],
		"bglocked" : 0,
		"defrect" : [ 122.0, 50.0, 1218.0, 602.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 452.0, 158.0, 102.0, 25.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 455.0, 120.0, 20.0, 20.0 ],
					"id" : "obj-22",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 557.0, 116.0, 50.0, 27.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 552.0, 172.0, 117.0, 25.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 18.0,
					"patching_rect" : [ 818.699951, 235.699951, 190.0, 27.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 1142.0, 340.0, 174.0, 27.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 745.0, 25.0, 85.0, 27.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 823.0, 277.0, 222.0, 27.0 ],
					"id" : "obj-66",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 18.0,
					"patching_rect" : [ 934.0, 128.0, 150.0, 27.0 ],
					"id" : "obj-65",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 823.0, 125.0, 104.0, 27.0 ],
					"id" : "obj-63",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 824.0, 163.0, 80.0, 60.0 ],
					"id" : "obj-61",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "importmovie glshade1.gif",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 868.0, 31.0, 212.0, 25.0 ],
					"id" : "obj-60",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 823.0, 88.0, 77.0, 27.0 ],
					"id" : "obj-58",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.handle bob @inherit_transform 1 @auto_rotate 1",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 167.0, 258.0, 439.0, 27.0 ],
					"id" : "obj-44",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 627.0, 228.0, 20.0, 20.0 ],
					"id" : "obj-43",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 18.0,
					"patching_rect" : [ 627.0, 259.0, 135.0, 25.0 ],
					"id" : "obj-41",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.gridshape bob @smooth_shading 1 @color 1 1 1 1 @shape sphere @scale 0.6 0.6 0.6 @dim 800 800 @matrixoutput 1",
					"linecount" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 18.0,
